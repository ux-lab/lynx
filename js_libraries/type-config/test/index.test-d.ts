...
describe('Test Config Types', () => {
  it('should have correct Config type', () => {
    ...
    expectTypeOf<Config>().toHaveProperty('enableBatchLayoutTaskWithSyncLayout').toEqualTypeOf<boolean | undefined>();
    ...
    expectTypeOf<Config>().toHaveProperty('enableNewSticky').toEqualTypeOf<boolean | undefined>();
    expectTypeOf<Config>().toHaveProperty('enableNewStylingPipeline').toEqualTypeOf<boolean | undefined>();
    ...
    expectTypeOf<Config>().toHaveProperty('enableUnifyFixedBehavior').toEqualTypeOf<boolean | undefined>();
