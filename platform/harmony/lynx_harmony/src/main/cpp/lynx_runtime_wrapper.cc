...
#define DECLARE_NAPI_FUNCTION(name, func) \
  ...
  napi_property_descriptor properties[] = {
      ...
      DECLARE_NAPI_FUNCTION("nativeSubscribeSessionStorage",
                            NativeSubscribeSessionStorage),
      DECLARE_NAPI_FUNCTION("nativeUnsubscribeSessionStorage",
...
napi_value LynxRuntimeWrapper::NativeSetSessionStorageItem(
    napi_env env, napi_callback_info info) {
  napi_value js_this;
  size_t argc = 2;
  ...
  napi_status status =
      napi_unwrap(env, js_this, reinterpret_cast<void**>(&obj));
  if (!CheckNapiUnwrapObject(status, obj,
                             "NativeSetSessionStorageItem failed")) {
    return nullptr;
  }
  ...
  obj->RuntimeStandalone().SetSessionStorageItem(std::move(key), template_data);
  return nullptr;
}

napi_value LynxRuntimeWrapper::NativeGetSessionStorageItem(
    napi_env env, napi_callback_info info) {
  napi_value js_this;
  size_t argc = 2;
  napi_value args[2] = {nullptr};
  ...
  napi_status status =
      napi_unwrap(env, js_this, reinterpret_cast<void**>(&obj));
  if (!CheckNapiUnwrapObject(status, obj,
                             "NativeGetSessionStorageItem failed")) {
    return nullptr;
  }
  ...
  obj->RuntimeStandalone().GetSessionStorageItem(std::move(key),
                                                 std::move(callback));
  return nullptr;
}

napi_value LynxRuntimeWrapper::NativeSubscribeSessionStorage(
    napi_env env, napi_callback_info info) {
  napi_value js_this;
  size_t argc = 2;
  napi_value args[2] = {nullptr};
  ...
  napi_status status =
      napi_unwrap(env, js_this, reinterpret_cast<void**>(&obj));
  if (!CheckNapiUnwrapObject(status, obj,
                             "NativeSubscribeSessionStorage failed")) {
  ...
  int32_t callback_id = obj->RuntimeStandalone().SubscribeSessionStorage(
...
napi_value LynxRuntimeWrapper::NativeUnsubscribeSessionStorage(
    napi_env env, napi_callback_info info) {
  napi_value js_this;
  size_t argc = 2;
  napi_value args[2] = {nullptr};
  ...
  napi_status status =
      napi_unwrap(env, js_this, reinterpret_cast<void**>(&obj));
  if (!CheckNapiUnwrapObject(status, obj,
                             "NativeUnsubscribeSessionStorage failed")) {
    return nullptr;
  }
  ...
  obj->RuntimeStandalone().UnSubscribeSessionStorage(std::move(key),
                                                     callback_id);
